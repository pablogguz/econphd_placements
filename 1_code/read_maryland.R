...
data_final <- read_excel("maryland_raw.xls") # for merging
...
tenuretrack <- c("Assistant Professor", "Professor", "Lecturer", "School of",
                 ...
                 "Cornell Economics", "Louisiana State Univeristy", "SUNY Binghamton", "Carnegie Mellon",
                 "United States Naval Academy", "UIBE")
...
intl <- c("World Bank", "IMF", "UNU Wider", "International Monetary Fund", "Inter American Development Bank", 
          ...
          "IDB", "Bank of International Settlements")
...
private <- c("Consultant", "Deliveroo", "Uber", "Amazon", "Data Scientist", "Luohan Academy", 
             ...
             "BlackRock", "Citi Bank", "Morningstar", "BBVA Research", "United Parcel Service", "Secretariat Economists",
             "Power Auctions", "Insight Policy Research", "MITRE", "Asset Management", "Consulting", "LLC", "Invesco",
             "RTI International", "Capital Management", "Fund Advisors", "Freddie Mac", "Swissre", "Rivada Networks")
...
centralbanks <- c("Bank of Spain", "Bank of Canada", "Bank of Chile", "Federal Reserve", "FRB",
                  ...
                  "Bank of Thailand", "Bank of Portugal", "Bank of England", "Bank of Japan")
...
thinktanks <- c("Institute", "RAND", "RAND, Associate Economist", "Tax Policy Center", "IFPRI, Poverty Health and Nutrition Division",
                "Resources for the Future", "Opportunity Insights", "International Initiative for Impact Evaluation")
...
government <- c("U.S.", "Treasury", "U.S. Department of", "US Department of", "Federal Trade Commission",
                ...
                "Government of Japan", "Consumer Financial Protection Bureau", "Office of the Comptroller of the Currency",
                "Census", "Agency for Health Care Research and Quality", "Korea Capital Market Institution")
...
data_final[5:10] <- list(NULL) # remove unnecessary dummiess
...
write_xlsx(data_final, "maryland.xls")
