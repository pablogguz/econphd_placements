...
data_final <- read_excel("eui_raw.xlsx") # for merging
...
postdocs <- c("Postdoctoral")
postdocsnot <- c("Assistant Professor", "Lecturer", "World Bank Group")
...
tenuretrack <- c("Assistant Professor", "Assistant Professorship", "Lecturer")
...
intl <- c("World Bank", "IMF", "UNU Wider", "International Monetary Fund", "Inter American Development Bank", 
          ...
          "European Commission", "Latin American Development Bank")
...
centralbanks <- c("Bank of Spain", "Bank of Canada", "Bank of Chile", "Federal Reserve", "FRB",
                  ...
                  "Bundesbank","Banca d'Italia", "Banco de México", "Bank of Australia", "Danmarks Nationalbank",
                  "National Bank", "De Nederlandsche Bank", "Bank of Ireland")
...
thinktanks <- c("Resources for the Future", "Opportunity Insights", "American Enterprise Institute", "Rand", 
                ...
                "Korean Institute of Finance", "Data for Progress", "Research Alliance", "Iseak", "Fondazione")
...
write_xlsx(data_final, "eui.xlsx")
