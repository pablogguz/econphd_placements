...
data_final <- read_excel("stanford_raw.xls") # for merging
...
postdocsnot <- c("after one-year postdoc", ", then", "Post Doc)")
...
private <- c("Analysis Group", "Anaylsis Group", "Uber", "Amazon", "Facebook", "Air BnB", 
             ...
             "Meta", "Sidley Austin", "LinkedIn", "Safra Bank", "Ping An Bank", "PIMCO", "Investments",
             ...
             "Ohmconnect", "Netflix", "Keystone Strategy", "SiriusXM/Pandora")
...
write_xlsx(data_final, "stanford.xls")
