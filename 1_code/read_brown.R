...
data_final <- read_excel("brown_raw.xls") # for merging
...
postdocs <- c("Post-doc", "Postdoc", "Postdoctoral", "Post-doctoral", "postdoc", "Post Doc", "post-doc", 
              "post doc", "Post-Doc", "PostDoc", "Post")
postdocsnot <- c("after one-year postdoc", "first, one-year ", "after Postdoc", " then ", "deferred by one year ")
...
tenuretrack <- c("Business School", "University", "Department of Economics", "School of", "Yale SOM", "John Hopkins", 
                 ...
                 "Dartmouth", "LMU Munich", "Vanderbilt", "NYU", "CEMFI", "Boston College",
                 ...
                 "Carnegie Mellon", "Wharton", "Michigan State", "UGA", "McMaste", "Princeton", "HEC Paris",
                 "Columbia", "Schl of ", "Harvard", "U of Tokyo", "CREi", "Law School", "College", "Aix-Marseille",
                 "Cornell", "Collegio Carlo Alberto", "Nova SBE", "Getulio Vargas", "FGV",
                 "Naval Postgraduate School", "SUNY", "ITAM", "Stanford", "Berkeley",  "Notre Dame", "Northeastern", "West Point",
                 "Yale", "Einaudi Institute for Economics and Finance", "Assistant Professor", "New Economic School", "HEC Montreal",
                 "Georgetown", "UCL", "HEC", "Virginia Polytechnic Institute", "Indian Institute of Technology Kanpur",
                 "university", "UNC Chapel Hill", "Wesleyan", "HKUST", "Colegio de Mexico", "Caltech", "Michigan")

tenuretracknot <- c("Teaching-Track", "Lecturer")
...
private <- c("Analysis Group", "Anaylsis Group", "Uber", "Amazon", "Facebook", "Air BnB", 
             ...
             "KPMG", "PwC", "PricewaterhouseCoopers", "Dimensional Fund Advisors", "Oxera")
...
government <- c("Treasury", "Federal Trade Commission", "Congressional Budget Office","Joint Committee on Taxation", 
                ...
                "Office of Management and Budgets of New York", "Veterans Administration")
...
write_xlsx(data_final, "brown.xls")
