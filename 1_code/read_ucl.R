...
data_final <- read_excel("ucl_raw.xlsx") # for merging
...
tenuretrack <- c("Assistant Professor", "Assistant professor", "Lecturer", "University")
...
centralbanks <- c("Bank of Spain", "Bank of Canada", "Bank of Chile", "Federal Reserve", "FRB",
                  ...
                  "Banque de France", "Boston Fed", "St Louis Fed", "Bank of Lithuania")
...
write_xlsx(data_final, "ucl.xlsx")
