...
data_final <- read_excel("columbia_raw.xls") # for merging
...
postdocsnot <- c("after one-year postdoc", "first, one-year ", "after Postdoc", ", then ", "first,")
...
write_xlsx(data_final, "columbia.xls")
