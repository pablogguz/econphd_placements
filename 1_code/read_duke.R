...
data_final <- read_excel("duke_raw.xls") # for merging
...
tenuretracknot <- c("Lecturer,  University of ", "Research Manager", "Visiting")
...
private <- c("Consultant", "Deliveroo", "Uber", "Amazon", "Data Scientist", "Luohan Academy", 
             ...
             "BlackRock", "Citi Bank", "Morningstar", "PwC", "Barclay's", "Moody's", "Numeric Investors", "Abt")
...
government <- c("U.S.", "Treasury", "U.S. Department of", "US Department of", "Federal Trade Commission",
                ...
                "Bureau of Labor Statistics", "Department of Health and Human Services", "Korea Institute for Industrial Economics and Trade",
...
write_xlsx(data_final, "duke.xls")
